...
public class HomeController {
	 ...
	 * Spring Framework에 의해 준비된 컴포넌트는 필요한 곳에서 
	 * 선언만 하면 자동으로 주입이 된다
	 ...
	 * 객체의 method나 속성(변수)에 접근하기 위해서는 반드시 객체를 선언하고
	 * 생성자를 통하여 객체를 생성(초기화)해야 한다
	 * 그렇지 않으면 NullpointerException이 발생한다
	 ...
	 * 
	 * Spring Project에서는 new 키워드를 사용하는 경우가 많지 않다
	 * 
	 */
